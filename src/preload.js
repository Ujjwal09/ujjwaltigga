...
contextBridge.exposeInMainWorld('tg', {
  ...
  getPlan: (dateKey) => ipcRenderer.invoke('plan:get', dateKey),
  setPlan: (dateKey, slots) => ipcRenderer.invoke('plan:set', dateKey, slots),
  getCatMap: () => ipcRenderer.invoke('catmap:get'),
  setCatMap: (map) => ipcRenderer.invoke('catmap:set', map),
